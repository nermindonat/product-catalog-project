      ...
      <div className="mx-auto px-4 sm:px-6">
        <div className="flex items-center border-b-2 border-gray-100 py-6 md:justify-start ">
          ...
          <div className="hidden items-center justify-end md:flex md:flex-1 lg:w-0">
            <select id="countries" className=" border border-gray-300 font-medium text-gray-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
